 ...
 * Description: To define all the method in linkedlist class
 * Date: 02/06/2018
 ---------------------------------------------------------------------------- */
#include <iostream>
...
template <typename T>
void LinkedList<T>::printlength()
{
  std::cout<<"The length of the LinkedList is "<<m_length<<"\n";
}
...
void LinkedList<T>::printlist()
{
  ...
  else
  {
    Node<T>* ptr = m_front;
    T value;
    std::cout<<"Below is the your linkedlist: \n";
    for(int i=0;i<m_length;i++)
    {
      value = ptr->getValue();
      std::cout<< value<<" ";
